...
Highway HighwayType(const char *highway)
{
	...
	case 'c':
		if (!strcmp(highway, "cycleway"))
			return (Highway_Cycleway);
		break;

	case 'f':
		if (!strcmp(highway, "ferry"))
			return (Highway_Ferry);
		break;
	...
	case 'p':
		...
		if (!strcmp(highway, "path"))
			return (Highway_Path);
		break;

	case 'r':
		if (!strcmp(highway, "residential"))
			return (Highway_Residential);
		break;
	...
	case 't':
		...
		if (!strcmp(highway, "track"))
			return (Highway_Track);
		break;

	case 'u':
		if (!strcmp(highway, "unclassified"))
			return (Highway_Unclassified);
		break;

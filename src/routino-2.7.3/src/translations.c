...
char *translate_raw_copyright_creator[2] =
...
char *translate_xml_copyright_creator[2] =
    { "Creator", "Routino - http://www.routino.org/" };
char *translate_xml_copyright_source[2] = { NULL, NULL };
char *translate_xml_copyright_license[2] = { NULL, NULL };

char *translate_xml_heading[9] =
    { "South", "South-West", "West", "North-West", "North", "North-East",
"East", "South-East", "South" };
char *translate_xml_turn[9] =
    { "Very sharp left", "Sharp left", "Left", "Slight left",
"Straight on", "Slight right", "Right", "Sharp right", "Very sharp right" };
char *translate_xml_ordinal[10] =
    { "First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh",
"Eighth", "Ninth", "Tenth" };

char *translate_raw_highway[Highway_Count] =
    { "", "motorway", "trunk road", "primary road", "secondary road",
"tertiary road", "unclassified road", "residential road", "service road", "track", "cycleway", "path",
"steps", "ferry" };
...
static int LanguageType_function(const char *_tag_, int _type_,
				 const char *lang);
//static int CopyrightType_function(const char *_tag_,int _type_);
static int TurnType_function(const char *_tag_, int _type_,
			     const char *direction, const char *string);
static int HeadingType_function(const char *_tag_, int _type_,
				const char *direction, const char *string);
static int OrdinalType_function(const char *_tag_, int _type_,
				const char *number, const char *string);
static int HighwayType_function(const char *_tag_, int _type_,
				const char *type, const char *string);
static int RouteType_function(const char *_tag_, int _type_,
			      const char *type, const char *string);
//static int HTMLType_function(const char *_tag_,int _type_);
//static int GPXType_function(const char *_tag_,int _type_);
static int CopyrightCreatorType_function(const char *_tag_, int _type_,
					 const char *string,
					 const char *text);
static int CopyrightSourceType_function(const char *_tag_, int _type_,
					const char *string,
					const char *text);
static int CopyrightLicenseType_function(const char *_tag_, int _type_,
					 const char *string,
					 const char *text);
static int HTMLWaypointType_function(const char *_tag_, int _type_,
				     const char *type, const char *string);
static int HTMLTitleType_function(const char *_tag_, int _type_,
				  const char *text);
static int HTMLStartType_function(const char *_tag_, int _type_,
				  const char *string, const char *text);
static int HTMLNodeType_function(const char *_tag_, int _type_,
				 const char *string, const char *text);
static int HTMLRBNodeType_function(const char *_tag_, int _type_,
				   const char *string, const char *text);
static int HTMLSegmentType_function(const char *_tag_, int _type_,
				    const char *string, const char *text);
static int HTMLStopType_function(const char *_tag_, int _type_,
				 const char *string, const char *text);
static int HTMLTotalType_function(const char *_tag_, int _type_,
				  const char *string, const char *text);
static int GPXWaypointType_function(const char *_tag_, int _type_,
				    const char *type, const char *string);
static int GPXDescType_function(const char *_tag_, int _type_,
				const char *text);
static int GPXNameType_function(const char *_tag_, int _type_,
				const char *text);
static int GPXStepType_function(const char *_tag_, int _type_,
				const char *text);
static int GPXFinalType_function(const char *_tag_, int _type_,
				 const char *text);
...
static xmltag *xml_toplevel_tags[] =
    { &xmlDeclaration_tag, &RoutinoTranslationsType_tag, NULL };
...
static xmltag RoutinoTranslationsType_tag = { "routino-translations",
	0, {NULL},
	NULL,
...
static xmltag LanguageType_tag = { "language",
	1, {"lang"},
	LanguageType_function,
	{&CopyrightType_tag, &TurnType_tag, &HeadingType_tag,
	 &OrdinalType_tag, &HighwayType_tag, &RouteType_tag, &HTMLType_tag,
	 &GPXType_tag, NULL}
};

/*+ The CopyrightType type tag. +*/
static xmltag CopyrightType_tag = { "copyright",
	0, {NULL},
	NULL,
	{&CopyrightCreatorType_tag, &CopyrightSourceType_tag,
	 &CopyrightLicenseType_tag, NULL}
};

/*+ The TurnType type tag. +*/
static xmltag TurnType_tag = { "turn",
	2, {"direction", "string"},
	TurnType_function,
	{NULL}
};
...
static xmltag HeadingType_tag = { "heading",
	2, {"direction", "string"},
...
static xmltag OrdinalType_tag = { "ordinal",
	2, {"number", "string"},
...
static xmltag HighwayType_tag = { "highway",
	2, {"type", "string"},
...
static xmltag RouteType_tag = { "route",
	2, {"type", "string"},
	RouteType_function,
	{NULL}
};
...
static xmltag HTMLType_tag = { "output-html",
	0, {NULL},
	NULL,
	{&HTMLWaypointType_tag, &HTMLTitleType_tag, &HTMLStartType_tag,
	 &HTMLNodeType_tag, &HTMLRBNodeType_tag, &HTMLSegmentType_tag,
	 &HTMLStopType_tag, &HTMLTotalType_tag, NULL}
};

/*+ The GPXType type tag. +*/
static xmltag GPXType_tag = { "output-gpx",
	0, {NULL},
	NULL,
	{&GPXWaypointType_tag, &GPXDescType_tag, &GPXNameType_tag,
	 &GPXStepType_tag, &GPXFinalType_tag, NULL}
};

/*+ The CopyrightCreatorType type tag. +*/
static xmltag CopyrightCreatorType_tag = { "creator",
	2, {"string", "text"},
...
static xmltag CopyrightSourceType_tag = { "source",
	2, {"string", "text"},
...
static xmltag CopyrightLicenseType_tag = { "license",
	2, {"string", "text"},
...
static xmltag HTMLWaypointType_tag = { "waypoint",
	2, {"type", "string"},
...
static xmltag HTMLTitleType_tag = { "title",
	1, {"text"},
...
static xmltag HTMLStartType_tag = { "start",
	2, {"string", "text"},
...
static xmltag HTMLNodeType_tag = { "node",
	2, {"string", "text"},
...
static xmltag HTMLRBNodeType_tag = { "rbnode",
	2, {"string", "text"},
...
static xmltag HTMLSegmentType_tag = { "segment",
	2, {"string", "text"},
...
static xmltag HTMLStopType_tag = { "stop",
	2, {"string", "text"},
...
static xmltag HTMLTotalType_tag = { "total",
	2, {"string", "text"},
...
static xmltag GPXWaypointType_tag = { "waypoint",
	2, {"type", "string"},
...
static xmltag GPXDescType_tag = { "desc",
	1, {"text"},
...
static xmltag GPXNameType_tag = { "name",
	1, {"text"},
...
static xmltag GPXStepType_tag = { "step",
	1, {"text"},
...
static xmltag GPXFinalType_tag = { "final",
	1, {"text"},
			     ...
			     const char *direction, const char *string)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		XMLPARSE_ASSERT_INTEGER(_tag_, direction);
		d = atoi(direction);
		...
		translate_xml_turn[d] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
	}
				...
				const char *number, const char *string)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		XMLPARSE_ASSERT_INTEGER(_tag_, number);
		n = atoi(number);
		XMLPARSE_ASSERT_STRING(_tag_, string);
			      ...
			      const char *type, const char *string)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		if (!strcmp(type, "shortest"))
			translate_xml_route_shortest =
			    strcpy(malloc(strlen(xmlstring) + 1),
				   xmlstring);
		else if (!strcmp(type, "quickest"))
			translate_xml_route_quickest =
			    strcpy(malloc(strlen(xmlstring) + 1),
				   xmlstring);
		else
			XMLPARSE_INVALID(_tag_, type);
					 ...
					 const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_raw_copyright_creator[0] =
		    strcpy(malloc(strlen(string) + 1), string);
		translate_raw_copyright_creator[1] =
		    strcpy(malloc(strlen(text) + 1), text);

		xmlstring = ParseXML_Encode_Safe_XML(string);
		xmltext = ParseXML_Encode_Safe_XML(text);

		translate_xml_copyright_creator[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_xml_copyright_creator[1] =
		    strcpy(malloc(strlen(xmltext) + 1), xmltext);
	}
					...
					const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_raw_copyright_source[0] =
		    strcpy(malloc(strlen(string) + 1), string);
		translate_raw_copyright_source[1] =
		    strcpy(malloc(strlen(text) + 1), text);

		xmlstring = ParseXML_Encode_Safe_XML(string);
		xmltext = ParseXML_Encode_Safe_XML(text);

		translate_xml_copyright_source[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
					 ...
					 const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_raw_copyright_license[0] =
		    strcpy(malloc(strlen(string) + 1), string);
		translate_raw_copyright_license[1] =
		    strcpy(malloc(strlen(text) + 1), text);

		xmlstring = ParseXML_Encode_Safe_XML(string);
		xmltext = ParseXML_Encode_Safe_XML(text);

		translate_xml_copyright_license[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
	...
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		if (!strcmp(type, "waypoint")) {
			translate_html_waypoint =
			    malloc(strlen(xmlstring) + 1 +
				   sizeof("<span class='w'>") +
				   sizeof("</span>"));
			sprintf(translate_html_waypoint,
				"<span class='w'>%s</span>", xmlstring);
		} else if (!strcmp(type, "junction"))
			translate_html_junction =
			    strcpy(malloc(strlen(xmlstring) + 1),
				   xmlstring);
				  ...
				  const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_start[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_start[1] =
		    malloc(strlen(xmltext) + 1 +
			   sizeof("<span class='b'>") + sizeof("</span>"));
		sprintf(translate_html_start[1], xmltext, "%s",
			"<span class='b'>%s</span>");
	}
				 ...
				 const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_node[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_node[1] =
		    malloc(strlen(xmltext) + 1 +
			   2 * sizeof("<span class='b'>") +
			   2 * sizeof("</span>"));
		sprintf(translate_html_node[1], xmltext, "%s",
			"<span class='t'>%s</span>",
			"<span class='b'>%s</span>");
	}
				   ...
				   const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_rbnode[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_rbnode[1] =
		    malloc(strlen(xmltext) + 1 +
			   2 * sizeof("<span class='b'>") +
			   2 * sizeof("</span>"));
		sprintf(translate_html_rbnode[1], xmltext, "%s",
			"<span class='t'>%s</span>",
			"<span class='b'>%s</span>");
	}
				    ...
				    const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_segment[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_segment[1] =
		    malloc(strlen(xmltext) + 1 +
			   2 * sizeof("<span class='b'>") +
			   2 * sizeof("</span>"));
		...
		p += 2;
		strcpy(q, "<span class='h'>%s</span>");
		q += sizeof("<span class='h'>%s</span>") - 1;

		while (*p != '%')
			*q++ = *p++;

		strcpy(q, "<span class='d'>");
		q += sizeof("<span class='d'>") - 1;
				 ...
				 const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_stop[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_stop[1] =
		    strcpy(malloc(strlen(xmltext) + 1), xmltext);
	}
				  ...
				  const char *string, const char *text)
{
	if (_type_ & XMLPARSE_TAG_START && store) {
		...
		translate_html_total[0] =
		    strcpy(malloc(strlen(xmlstring) + 1), xmlstring);
		translate_html_total[1] =
		    strcpy(malloc(strlen(xmltext) + 1), xmltext);
	}
...
int ParseXMLTranslations(const char *filename, const char *language)
{
	...
	if (!ExistsFile(filename)) {
		fprintf(stderr,
			"Error: Specified translations file '%s' does not exist.\n",
			filename);
		return (1);
	}
	...
	if (language && !stored)
		fprintf(stderr,
			"Warning: Cannot find translations for language '%s' using English instead.\n",
			language);
